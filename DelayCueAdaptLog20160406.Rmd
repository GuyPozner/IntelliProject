...
sessionPath <- "Sessions/2016-04-06 16.44.53/"
...
windowNosepokes$ReactTime <- findReactTimes(visits, windowNosepokes, delay = 1.5)
...
windowNosepokes$Hour <- as.factor(windowNosepokes$Hour)
p4 <- ggplot(windowNosepokes, aes(ReactTime, fill = Hour)) +
